        ...
        <div class="row row-pb-lg product-detail-wrap">
                    ...
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="/php2/public/images/<?php echo $p[0]['hinh']?>" class="img-fluid" alt="Free html5 bootstrap 4 template">
                            </a>
                        </div>
                    </div>
                    <div class="item">
            ...
            <div class="col-sm-4">
                <div class="product-desc">
                    <h3><?php echo $p[0]['tenhh'];?></h3>
                    <p class="price">
                        <span><?php echo number_format($p[0]['dongia']) . " VNĐ";?></span> 
                        <span class="rate">
